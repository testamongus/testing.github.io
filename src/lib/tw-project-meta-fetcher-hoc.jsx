...
const API_URL = 'https://snailidebackend.replit.app/api/projects/getPublished?id=$id';
const API_REMIX_URL = 'https://snailidebackend.replit.app/api/pmWrapper/remixes?id=$id';
