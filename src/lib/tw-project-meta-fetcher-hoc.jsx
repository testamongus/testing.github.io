...
const API_URL = 'https://projects.snail-ide.com/api/projects/getPublished?id=$id';
const API_REMIX_URL = 'https://projects.snail-ide.com/api/pmWrapper/remixes?id=$id';
