...
const MENU_OPTIONS = 'optionsMenu';
...
const openSettingsMenu = () => openMenu(MENU_OPTIONS);
const closeSettingsMenu = () => closeMenu(MENU_OPTIONS);
const settingsMenuOpen = state => state.scratchGui.menus[MENU_OPTIONS];
